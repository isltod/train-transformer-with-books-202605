...
class CausalAttention(nn.Module):
    ...
    def __init__(self, d_in, d_out, context_length, dropout, qkv_bias=False):
        ...
        # register_buffer는 역전파로 학습되지 않지만 그 외에는 다른 매개변수와 같은 텐서...
        # 이걸 별도의 텐서로 만들면 그것도 모델 따라서 gpu로 이동시켜줘야 하는데 여기 선언하면 그럴 필요가 없다...
        # 상삼각 부분만 1로 채운 텐서를 mask 속성으로...배치 차원 없는 2차원 텐서..
